...
from ska_oso_odt_services.codec import CustomJSONEncoder

KUBE_NAMESPACE = os.getenv("KUBE_NAMESPACE", "ska-oso-odt-services")
ODT_MAJOR_VERSION = version("ska-oso-odt-services").split(".")[0]
